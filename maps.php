...
<div class="mpimgclose">X</div>
<img id="mpimg2b" class="mpimgb" src="baitasi.png">
</div>

<div hidden id="mpimg3a" class="mpimga">
<div class="mpimgclose">X</div>
<img id="mpimg3b" class="mpimgb" src="lotusblue.jpg">
</div>

<div hidden id="mpimg4a" class="mpimga">
<div class="mpimgclose">X</div>
<img id="mpimg4b" class="mpimgb" src="bmonh.jpg">
</div>

<div hidden id="mpimg5a" class="mpimga">
<div class="mpimgclose">X</div>
...
<div style="font-size: 14pt; font-family: vt323;"><span style="color: red;">The year is 2078 - Year of the Earth Dog</span>
...
$(function() {	
	...
	$('#mpimg3').click(function(e) {
		$('#mpimg3a').toggle();
	});
	$('#mpimg4').click(function(e) {
		$('#mpimg4a').toggle();
	});
	$('#mpimg5').click(function(e) {
		$('#mpimg5a').toggle();
	});
